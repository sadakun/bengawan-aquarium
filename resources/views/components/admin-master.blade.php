...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <x-admin.sidebar.nav-item></x-admin.sidebar.nav-item>
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <!-- Nav Item Top - User Information -->
            <x-admin.topbar.nav-user-info></x-admin.topbar.nav-user-info>
          </ul>
 ...
 <!-- summernote css/js -->
  ...
  <script>
    $(document).ready(function() {
        ...
        var element = $('ul.sidebar a').filter(function() {
